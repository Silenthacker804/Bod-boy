...
prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks5&timeout=100000&country=all&ssl=all&anonymity=all').text
  ...
  TEMAN = f'Opera/9.80 (SpreadTrum; Opera Mini/{str(rr(1,10))}.{str(rr(1,10))}.{str(rr(111,9999))}/{str(rr (111,300))}.{str(rr(111,300))}; U; sv; Presto/{str(rr(1,10))}.{str(rr(10,20))}.{str(rr(100,500))} Version/{str(rr(1,20))}.{str(rr(1,20))} 
