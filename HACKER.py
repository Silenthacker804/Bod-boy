...
def login_lagi334():
	...
	warna = random.choice([
 P, M, H, K, B, U, O, N])
	cetak(nel(f"[bold green]ARMBF [bold yellow]MEMINTA ANDA UNTUK MEMASUKAN COOKIES ",style="blue bold",title="[bold red]•[bold cyan ]•[bold green]•[bold red] informasi [bold green]•[bold blue]•[bold red]•"))
