...
#(["Mozilla/5.0 (Windows NT 10.0; WOW64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5127.98 Safari/537.36",
...
#	prog.update(des,description=f'[deep_pink3]Val{str(loop)}/{len(id)}[/] OK : [green]{len(ok)}[/] CP : [yellow]{len(cp)}[/]')
#        prog.advance(des)
