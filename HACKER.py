...
def menu(my_name,my_id):
	...
	banner()
	sg = '# SCRIPT INI HANYA BOLEH DI GUNAKAN OLEH ORANG YANG SUDAH MEMPEROLEH IZIN DARI AUTHOR : SHINZY, KONTAK IZIN AKSES WA:085740559254, JIKA ADA SALAH SATU PIHAK MEMPERJUAL BELI KAN SCRIPT , MAKA AUTHOR TIDAK BERTANGGUNG JAWAB ATAS KERUGIAN YANG DI TANGGUNG KORBAN, SEKALI LAGI SAYA TIDAK PERNAH MENJUAL BELIKAN SCRIPT "TRIMAKASIH" '
